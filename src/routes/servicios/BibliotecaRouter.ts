...
export class BibliotecaDigitalRouter {
  private controller: BibliotecaDigitalController;
  private prefix: string = "/servicios/biblioteca-digital";

  constructor() {
    this.controller = new BibliotecaDigitalController();
  }
