...
const InfractoresModel_1 = __importDefault(require("../../../models/matriculados/servicios/infractores/InfractoresModel"));
...
class InmobiliariasIlegalesPenalController {
    async getAll(req, res) {
        ...
        try {
            const result = await InfractoresModel_1.default.getAll(params);
            res.json(result);
        }
        catch (e) {
    ...
    async create(req, res) {
        ...
        try {
            ...
            await InfractoresModel_1.default.create({ nombre, fecha, direccion });
    ...
    async setActive(req, res) {
        ...
        try {
            const result = await InfractoresModel_1.default.setActive({ id, estado });
    ...
    async delete(req, res) {
        const id = parseInt(req.params.id);
        try {
            const result = await InfractoresModel_1.default.delete({ id });
    ...
    async update(req, res) {
        ...
        try {
            await InfractoresModel_1.default.update({ id, nombre, direccion, fecha });
